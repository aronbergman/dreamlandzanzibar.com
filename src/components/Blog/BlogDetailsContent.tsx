              ...
              <div className="blog-details-content">
                ...
                <div className="tag-share">
                  <div className="d-md-flex align-items-center justify-content-between">
                    <ul className="ps-0 mb-2 mb-md-0 list-unstyled d-flex align-items-center tag-list">
                      <li>
                    ...
                    <ul className="ps-0 mb-0 list-unstyled d-flex align-items-center social-link">
                      <li>
                        <span>Share:</span>
                      </li>
                      <li>
